# Looker Extension Scholar (React & JavaScript)

This example demonstrates a bare bones Looker extension using Javascript.

## Getting Started for Development

1. Clone the Looker extension scholar.

   ```
   # cd ~/ Optional, your user directory is usually a good place to git clone to.
   git clone git@github.com:JCampbell-Sovrn/scholar.git
   ```

2. Navigate (`cd`) to the example directory on your system

   ```
   cd /Users/jcampbell/Documents/GitHub/scholar/javascript/src/scholar.js
   ```
...
6. Create a `model` LookML file in your project. The name doesn't matter but the convention is to name it the same as the project— in this case, scholar.
